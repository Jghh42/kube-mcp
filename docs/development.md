...
The test suite covers access policy, authentication, Secret sanitization and fingerprinting, generic compact LIST summaries, upstream and safe-output boundaries, pagination, cancellation, timeouts, readiness, reverse proxies, audit sinks, telemetry, production deployment settings, and the single-tool MCP surface.
